      ...
      <div class="container px-6 mx-auto grid">
        <ul class="flex py-6 text-sm lg:text-base">
          <li class="inline-flex text-gray-700 items-center dark:text-gray-400">
            <inertia-link :href="route('salidas.index')">Salidas</inertia-link>
            <svg
                ...
                <table class="text-sm my-2">
                  <tbody>
                    ...
                    <div
                      ...
                      class="px-4 py-2 text-xs py-2 text-red-400 dark:text-red-400"
                    >
                      Los datos del cliente son requerido
                    </div>
                  </tbody>
                </table>
              </div>
                      ...
                      >
                        ...
                        <div class="overflow-y-auto h-32">
                          ...
                          >
                            <li
                              class="flex"
                              v-for="(cliente, index) in resultQuery"
                              :key="index"
                            >
                              <button
        ...
        <jet-modal :show="openModal" @close="openModal = false">
          ...
          >
            ...
            <form @submit.prevent="addItemMP">
              <div
                class="flex flex-col px-6 dark:text-gray-400 dark:bg-gray-800"
              >
                    ...
                    <div class="relative">
                      <div>
                        ...
                        <div class="flex w-full items-center ">
                          <div class="w-full items-center mt-1 flex relative focus-within:text-purple-500">
                            <div
...
export default {
  ...
  methods: {
    addItemMP() {
      ...
      if (!this.itemsMP.PrecioUnitario) {
        this.errores.push("El precio es obligatorio.");
      }
      if (this.itemsMP.Cantidad > this.Stock) {
        this.errores.push("La cantidad no puede ser mayor el stock actual.");
      }
    ...
    selectProveedor(UserID, ClienteID, clieNombre, clieRuc) {
      this.form.user_id = UserID;
      this.form.persona_id = ClienteID;
      this.clieNombre = clieNombre;
      this.clieRuc = clieRuc;
    },

    submit() {
      this.$inertia.post(route("salidas.store"), [this.form, this.arrayItemMP]);
    },
    ...
    setBuscarP(productoID, buscarp, stockp, precioP, unidadMediadP) {
      this.itemsMP.idProducto = productoID;
      this.itemsMP.buscarP = buscarp;
      this.Stock = stockp;
      this.UnidadMedida = unidadMediadP;
      this.itemsMP.PrecioUnitario = precioP;
