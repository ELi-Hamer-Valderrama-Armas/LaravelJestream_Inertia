            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <td class="px-4 py-3 text-sm">
                          {{ ingreso.SerieComprobante }}
                        </td>
                        <td class="px-4 py-3 text-sm">
                          {{ ingreso.NumeroComprobante }}
                        </td>
                        <td class="px-4 py-3 text-sm">
                          {{ ingreso.personas.Nombres }}
                        </td>
                        <td class="px-4 py-3 text-sm">
                          {{ ingreso.users.name }}
                        </td>
                  ...
                  <jet-pagination :links="ingresos.links" />
                  ...
                  <jet-confirmation-modal :show="isOpen" @click="closeModal">
                    ...
                    <template #footer>
                      ...
                      <inertia-link
                        ...
                        method="delete"
                        :href="route('ingresos.destroy', datos)"
                        @click="closeModal"
                      >
                        Eliminar
                      </inertia-link>
  ...
  watch: {
    params: {
      ...
      handler: throttle(function () {
        this.$inertia.get(route("ingresos.index"), this.params, {
          preserveState: true,
        });
      }, 150),
    },
