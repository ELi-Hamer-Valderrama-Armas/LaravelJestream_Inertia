            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <td class="px-4 py-3 text-sm">
                          {{ proveedor.Ciudad }} - {{ proveedor.Calle }} - 
                          {{ proveedor.Numero }}
                        </td>
                  ...
                  <jet-pagination :links="proveedores.links" />

                  <jet-confirmation-modal :show="isOpen" @click="closeModal">
                    <template #title> Eliminar Proveedor </template>

                    <template #content>
                      Si eliminas este proveedor también se eliminaran los productos
                      que haya abastecido. ¿Esta seguro de Eliminar esta proveedor?.
                    </template>
                    ...
                    <template #footer>
                      ...
                      <inertia-link
                        ...
                        method="delete"
                        :href="route('proveedores.destroy', datos)"
                        @click="closeModal"
                      >
                        Eliminar
                      </inertia-link>
  ...
  watch: {
    params: {
      ...
      handler: throttle(function () {
        this.$inertia.get(route("proveedores.index"), this.params, {
          preserveState: true,
        });
      }, 150),
    },
