            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
              ...
              >
                ...
                >
                  ...
                  <jet-pagination :links="categorias.links" />

                  <jet-confirmation-modal :show="isOpen" @click="closeModal">
                    <template #title> Eliminar Categoría </template>

                    <template #content>
                      Si eliminas esta categoría también se eliminaran los
                      productos que le pertenecen. ¿Esta seguro de Eliminar esta
                      categoría?.
                    </template>
                    ...
                    <template #footer>
                      ...
                      <inertia-link
                        ...
                        method="delete"
                        :href="route('categorias.destroy', datos)"
                        @click="closeModal"
                      >
                        Eliminar
                      </inertia-link>
  ...
  watch: {
    params: {
      ...
      handler: throttle(function () {
        this.$inertia.get(route("categorias.index"), this.params, {
          preserveState: true,
        });
      }, 150),
    },
