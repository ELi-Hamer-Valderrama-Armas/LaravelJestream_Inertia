...
export default {
  ...
  data() {
    return {
      form: {
        TipoPersona:JSON.parse(this.$props.clientes).TipoPersona,
        RazonSocial:JSON.parse(this.$props.clientes).RazonSocial,
        TipoDocumento:JSON.parse(this.$props.clientes).TipoDocumento,
        NumeroDocumento:JSON.parse(this.$props.clientes).NumeroDocumento,
        Nombres: JSON.parse(this.$props.clientes).Nombres,
        Telefono:JSON.parse(this.$props.clientes).Telefono,
        Email:JSON.parse(this.$props.clientes).Email,
        Ciudad:JSON.parse(this.$props.clientes).Ciudad,
        Calle:JSON.parse(this.$props.clientes).Calle,
        Numero:JSON.parse(this.$props.clientes).Numero,
      },
    };
  },
  methods: {
    submit() {
      this.$inertia.put(
        route("clientes.update", JSON.parse(this.$props.clientes).id),
        this.form
      );
    },
  },
